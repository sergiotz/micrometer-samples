...
class SampleController {
    ...
    SampleController(MyUserService myUserService, ObservationRegistry registry, Tracer tracer) {
    ...
    @Observed
    @GetMapping("/span")
    public String saySpan() {
        LOGGER.info("Controller span");
        return myUserService.userName("hello");
    }
